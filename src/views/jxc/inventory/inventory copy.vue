              ...
              <div class="left">
                ...
                <div class="info">
                  ...
                  <p>
                    ...
                    数量：{{ k.packageNumber }} /
                    <span style="color: rgba(39, 137, 237, 1)"
                      >{{ k.packageNumber - k.lockedNumber }}件</span
                    >
                  </p>
                </div>
              </div>
      ...
      <div slot class="sidebar_content">
        <div class="item_box">
          <div class="item">
            ...
            <div
              class="content_item"
              :class="{ minH: ismoreobj[wareHouse.length - 1] }"
            >
              <div
                @click="click(v)"
                class="textover"
          ...
          <div class="item" v-for="k in sideInfo" :key="k.key">
            ...
            <div
              class="content_item"
              :class="{ minH: ismoreobj[k.list.length - 1] }"
            >
              <div
  ...
  methods: {
    ...
    async getStoreDate() {
      ...
      const res = await this.$axios.get(
        'http://192.168.0.199:8066/storePackage/inventorySummary',
        {
          params: {
            attribute:
    ...
    getStore() {
      setTimeout(() => {
        this.storeList.push(this.pageNum++)
        this.storeList.push(this.pageNum++)
        this.storeList.push(this.pageNum++)
        this.storeList.push(this.pageNum++)
        if (this.pageNum > 20) {
...
#inventory {
  ...
  .main {
    height: 100%;
    box-shadow: 0 -0.04rem 0.12rem 0 rgba(51, 51, 51, 0.12);
    overflow: hidden;
    .title {
      padding-top: 0.25rem;
